...
interface VerifiedIconProps extends SVGProps<SVGSVGElement> {
  colorStop1?: string;
  colorStop2?: string;
}
...
export default function VerifiedIcon({
  ...
  const id = useId();
  const paintId = `paint0_linear_${id}`;
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor={colorStop1} data-testid="color-stop-1" />
          <stop offset="1" stopColor={colorStop2} data-testid="color-stop-2" />
        </linearGradient>
        <clipPath id={clipId}>
